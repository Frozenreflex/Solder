...
public abstract class BaseCompileMode
{
    ...
    protected static void CompileButtonMethod(string findPath, BaseCompileMode compileMode, bool compileMonopack, bool compilePersistent, Slot compileSlot, Slot importRoot)
    {
